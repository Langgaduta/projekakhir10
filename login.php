            ...
            <div class="container" style="margin-top: 150px;">
                <div class="row">
                    <div class="col-md-7 mb-5">
                        ...
                        <p class="lead mt-3 fs-3">Menyediakan tempat untuk bershodaqoh, melihat galeri masjid, manfaat bershodaqoh, dan yang lainya.</p>
                    </div>
                    <div class="col-md-5">
                            ...
                            <div class="container-fluid pt-3 pb-5 ps-5 pe-5">
                                <div class="row">
                                    <div class="card-body">
                                        ...
                                        <form class="mt-4">
                                            <div class="mb-3">
                                                <label for="email" class="form-label fw-bolder">Username</label>
                                            ...
                                            <div class="d-grid gap-2">
                                                <button class="btn text-light" style="background-color : #1F3984" type="button">Login</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
